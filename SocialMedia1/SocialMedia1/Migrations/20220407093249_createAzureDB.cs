    ...
    public partial class createAzureDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserRequesterId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowRequests", x => new { x.UserId, x.UserRequesterId });
                    table.ForeignKey(
                        name: "FK_FollowRequests_UserProfiles_UserId",
                        column: x => x.UserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FollowRequests_UserProfiles_UserRequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfilesGroups", x => new { x.UserProfileId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_UserProfilesGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserProfilesGroups_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowRequests_UserRequesterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfilesGroups_GroupId",
                table: "UserProfilesGroups",
                column: "GroupId");
